...
import { LEAGUES, TEAM_BULK_IMPORT, REQUEST_TYPE, SESSION } from '../helper/APIInfo';
	...
	const handleSave = async (event) => {
		...
		if (formData?.season === '') {
			...
			try {
				...
				apiCallFile(TEAM_BULK_IMPORT.upload, REQUEST_TYPE.POST, formDatas).then((results) => {
