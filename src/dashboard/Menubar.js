  ...
  return (
    ...
    <section className='navheader'>
      <Container fluid>
        ...
        <Link><i class="ri-login-box-line"></i> Login</Link>
        ...
        <div className="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100">
            <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start menuitem_s" id="menu">
                <li className="nav-item">
                    ...
                    <i class="ri-dashboard-line"></i> <span className="ms-1 d-none d-sm-inline">Dashboard</span>
                    </Link>
                </li>
                <li>
                    ...
                    <li className="w-100">
                            <Link to="/Edithome" className="nav-link px-0"> <span className="d-none d-sm-inline">Home</span></Link>
                        </li>
                        <li className="w-100">
                            <Link to="/Editabout" className="nav-link px-0"> <span className="d-none d-sm-inline">About us</span></Link>
                        </li>
                        <li className="w-100">
