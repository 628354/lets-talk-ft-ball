...
export default function Editprivacypolicy() {
	...
	useEffect(() => {
		axios
			.get(
				"https://phpstack-1140615-3967632.cloudwaysapps.com/backend/getpolicy"
			)
			.then((response) => {
	...
	const handleUpdateData = () => {
		...
		axios
			.post(
				"https://phpstack-1140615-3967632.cloudwaysapps.com/backend/updatePolicy/" +
					itemId,
				formData,
				{
					headers: {
												...
												<div className="bannerimage">
													<Form>
														...
														<Form.Group
															...
															<Form.Label>
																Privacy & Usage Terms Textarea
															</Form.Label>
															<ReactQuill
																className="edit-text"
																value={aboutData.privacy_policy}
																onChange={(value) =>
																	handleTextChange("privacy_policy", value)
																}
															/>
														</Form.Group>
													</Form>
