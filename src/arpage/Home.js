...
import Headersliderar from '../components/Headersliderar';
           ...
           <div className='ar_leagues_cont'>
             ...
             <div className='leagues_slider'>
               ...
               <div className='sp_botton'>
                 <button className='ar_spc_button'>سيتم إضافة المزيد من الدوريات</button>
               </div>
             </div>
           </div>
         </div>
